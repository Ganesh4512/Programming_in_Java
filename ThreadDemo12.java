...
class DemoOdd extends Thread
{
    ...
    public void run()
    {
        for(int i = 0; i < dobj.Arr.length; i++)
        {
            if(dobj.Arr[i] % 2 != 0)
            {
                System.out.println(" Odd is "+dobj.Arr[i]);
            }
        }
...
class DemoEven extends Thread
{
    ...
    public void run()
    {
        for(int i =0; i < dobj.Arr.length; i++)
        {
            if(dobj.Arr[i] % 2 == 0)
            {
                System.out.println(" Even is "+dobj.Arr[i]);
            }
        }
...
class ThreadDemo12 
{
    ...
    {   
        ...
        DemoEven eobj = new DemoEven(obj1);  //same data dela
        DemoOdd oobj = new DemoOdd(obj1);   //same 
